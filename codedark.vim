...
let s:cdLineNumber = {'gui': '#5A5A5A', 'cterm': s:cterm11, 'cterm256': '240'}
...
if g:codedark_italics | call <sid>hi('Comment', s:cdGrey, {}, 'italic', {}) | else | call <sid>hi('Comment', s:cdGray, {}, 'none', {}) | endif

call <sid>hi('Constant', s:cdBlue, {}, 'none', {})
call <sid>hi('String', s:cdYellowOrange, {}, 'none', {})
call <sid>hi('Character', s:cdYellowOrange, {}, 'none', {})
...
call <sid>hi('SpecialChar', s:cdLightBlue, {}, 'none', {})
